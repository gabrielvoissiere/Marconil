const en = {
    ...
    home_page: {
        ...
        work: {
            title: 'How we work ?',
            subtitle: 'Our agency take the time with you for understand exactly and precisely what you want for your factory.',
            first_block: {
                title: 'Comprehension',
    ...
    project_page: {
        ...
        graphic: {
            ...
            subtitle: 'we have created graphic charts with different styles to have a wide choice of design for the customer'
        },
        result: {
        ...
        final: {
            title: 'Final',
            subtitle: 'After many calls and reflections we validated the last graphic charter, which thanks to that, allowed us to move to the designs of the whole site and its development'
        },
        contact: {
            title: 'Contact us',
            subtitle: 'We answer in 4 hours',
