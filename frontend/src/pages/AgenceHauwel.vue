<template>
  <section id="AgenceHauwel">
    <div id="above_the_fold">
      <div class="title">
        <h2>Agence HAUWEL</h2>
        <div class="line"></div>
        <p class="special_text">
          Réalisation de la charte graphique, du web design, de l'UX/UI et du
          developpement du site web
        </p>
      </div>
      <img
      ...
      />
      <p>
        Agence HAUWEL est une agence de photographie avec laquelle nous avons du
        réaliser, la direction artistique, le web design, l’UX/UI ainsi que le
        développement web. L’agence se voulait d’être sobre et moderne.
      </p>
    </div>
